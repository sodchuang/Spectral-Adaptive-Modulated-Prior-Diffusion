...
def main():
    ...
    for i in range(num_eval):
        ...
        with torch.no_grad():
            ...
            if inference_times:
                ...
                timing_file = f"il_outputs/{args.algo}/{args.task}/eval/{ckpt_name}/{i}_timing.txt"
    ...
    log.info(f"FINAL RESULTS: Success Rate = {success_rate:.4f}")
    ...
    result_file = os.path.join(result_dir, "final_stats.txt")
