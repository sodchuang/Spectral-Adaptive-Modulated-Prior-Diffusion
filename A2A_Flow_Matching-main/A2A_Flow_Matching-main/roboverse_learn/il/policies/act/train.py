...
def main(args):
    ...
    backbone = 'resnet18'
    if policy_class == 'ACT':
        # Configurable transformer parameters (for fair comparison with other methods)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_layers', action='store', type=int, help='Number of encoder layers', required=False, default=4)
    parser.add_argument('--dec_layers', action='store', type=int, help='Number of decoder layers', required=False, default=7)
    parser.add_argument('--nheads', action='store', type=int, help='Number of attention heads', required=False, default=8)
